...
namespace CSharp_Proje_Ödevi_Deneme_vol11._0
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            var haarCascade = new CascadeClassifier("C:\\Users\\Salih\\Desktop\\haarcascade_frontalface_alt2.xml");
            ...
            if (durum)
            {
                if (!Directory.Exists(@"C:\Users\Salih\Desktop\Resimler"))
                    Directory.CreateDirectory(@"C:\Users\Salih\Desktop\Resimler");
                if (!Directory.Exists(@"C:\Users\Salih\Desktop\Resimler\insan"))
                    Directory.CreateDirectory(@"C:\Users\Salih\Desktop\Resimler\insan");
                if (!Directory.Exists(@"C:\Users\Salih\Desktop\Resimler\Manzara"))
                    Directory.CreateDirectory(@"C:\Users\Salih\Desktop\Resimler\Manzara");
                ...
                if (yüzSayısı < 1)
                {
                    File.Copy(ds.FileName, @"C:\Users\Salih\Desktop\Resimler\Manzara\" + imagepath.ToString());
                    //durum = false;
                ...
                {
                    File.Copy(ds.FileName, @"C:\Users\Salih\Desktop\Resimler\insan\" + imagepath.ToString());
